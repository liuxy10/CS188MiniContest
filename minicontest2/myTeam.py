...
def createTeam(firstIndex, secondIndex, isRed,
               first = 'OffensiveCleverAgent', second = 'DefensiveReflexAgent'):
  """
  ...
  def getFeatures(self, gameState, action):
    ...
    if len(foodList) > 0: 
      ...
      if minDistGhost != None:
        features['distanceToFood'] = 1/(minDistGhost+0.5)
    return features

  def getWeights(self, gameState, action):
    return {'successorScore': 50, 'distanceToFood': -1,'nearestGhostCost': 60}
